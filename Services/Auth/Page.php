...
Class Page extends \Tools\CommonCore\SmartWebsiteService {
    ...
    public function profile(){
        ...
        if (!$this->auth->user) {
            $redirect_link = $GLOBALS['app']['translate']['uri_prefix'].'/';
    ...
    public function facebook_redirect(){
        ...
        else $redirect_link = $GLOBALS['app']['translate']['uri_prefix'].'/auth/page/profile';
        $this->website->redirect_refresh($redirect_link);
    ...
    public function email_verification_code() {
        ...
        $this->data['redirect'] = $GLOBALS['app']['translate']['uri_prefix']."/";
