                ...
                <ul class="list-group text-center">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="mt-3">
                            ...
                            <?php if ($inside4_auth->in_groups(Array('admin'))) {?>
                                <a class="btn btn-primary w_full mb-3" target="_blank" href="<?=$lang_link_prefix?>/inside/panel/menu_tree">Inside Admin Panel &gt;&gt;</a>
                            <?php } ?>
                        </div>
